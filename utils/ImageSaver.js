...
module.exports = {
    ...
    // saveTwitterImages: function (tweetIdList, recursive = false) {
    //     const filter = {
    //         "tweet.fields": [
    //             "created_at",
    //             "entities",
    ...
    //         TwitterParser.getTweets(tweetIdList, filter)
    //             .then(_data => {

    //                 for (const data of _data.data) {
    ...
    //                                 return this.saveTwitterImage(tweet.id, recursive);
    //                             }
    //                         }
    //                     }
